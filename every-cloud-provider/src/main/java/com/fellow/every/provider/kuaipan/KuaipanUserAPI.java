...
public class KuaipanUserAPI extends AbstractAPI implements UserAPI{
	...
	public void assertAccessToken(AccessToken accessToken){
		...
		Assert.isInstanceOf(KuaipanAccessToken.class, accessToken, "AccessToken is not an instance of " + KuaipanAccessToken.class);
	}
