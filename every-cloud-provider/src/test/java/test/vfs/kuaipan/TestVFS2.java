...
public class TestVFS2 extends AbstractTestVFS2 {
	...
	public static void setUpBeforeClass() throws Exception {
        ...
        EveryDiskFileSystemConfigBuilder.getInstance().setAuthenticator(opts, KuaipanVFSTests.getAuthenticator());
		...
		setAccessToken(KuaipanVFSTests.getAuthenticator().requestAuthentication());
	}
}
