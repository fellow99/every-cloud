...
public abstract class AbstractShellAuthenticatorV20 extends AbstractAuthenticator{
	
	private InputStream in;

	public AbstractShellAuthenticatorV20(InputStream in){
		this.in = in;
	}
	...
	public AccessToken requestAuthentication() throws Exception {
        ...
        Token aToken = getService().getAccessToken(EMPTY_TOKEN, verifier);
